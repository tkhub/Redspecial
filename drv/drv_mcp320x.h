...
#define DRV_MCP320x_SINGLEND
#define DRV_MCP320x_VREF    5.0
#define DRV_MCP320x_CONV_A  (1.0)
#define DRV_MCP320x_CONV_B  (0.0)
#define DRV_MCP320x_MAXDAT   4096
/// 4096 = 5V
/// 
...
__GLOBAL    void    vdg_drv_mcp320x_setup(u8 ch);
__GLOBAL    void    vdg_drv_mcp320x_start(void);
__GLOBAL    u16     u16g_drv_mcp320x_sinput(u8 ch);
