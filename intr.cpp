...
///
////////////////////////////////////////////////////////////////////////////////
void vdg_sys_intr_fastintv_setup(void)
{
    MsTimer2::set(1, vdg_sys_intr_fastintv);
    MsTimer2::start();
}
...
///
////////////////////////////////////////////////////////////////////////////////
void vdg_sys_intr_fastintv(void)
{
    /*
    vdg_app_ui_intr();
    if (bis_sys_intr_test)
    {
        bis_sys_intr_test = false;
        digitalWrite (PNCF_UI_GREENLED, PNCF_UI_GREENLED_ON);
    }
    else
    {
        bis_sys_intr_test = true;
